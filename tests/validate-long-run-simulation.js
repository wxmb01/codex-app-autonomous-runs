...
assert.ok(events[0].reviewer.includes("launch_mode=specialized_no_fork_self_contained_prompt"));
assert.ok(events[0].reviewer.includes("no full-context fork requested"));
...
assert.ok(threeHourEvents[0].reviewer.includes("launch_mode=specialized_no_fork_self_contained_prompt"));
assert.ok(threeHourEvents[0].reviewer.includes("no full-context fork requested"));
