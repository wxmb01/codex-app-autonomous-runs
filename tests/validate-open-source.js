...
assert.ok(compactAgentsMd.includes("do not request a full-context fork"));
assert.ok(compactAgentsMd.includes("retry immediately"));
...
assert.ok(compactSkillMd.includes("do not combine that `agent_type` with a full-context fork"));
assert.ok(compactSkillMd.includes("self-contained prompt"));
assert.ok(compactSkillMd.includes("retry immediately with the same specialized reviewer and no fork"));
...
assert.ok(readme.includes("self-contained prompts rather than full-context forks"));
