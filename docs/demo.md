...
Specialized reviewers should be launched with self-contained prompts and no
full-context fork, so Codex does not hit an App tool rejection before review starts.
